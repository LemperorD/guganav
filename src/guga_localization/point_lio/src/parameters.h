...
extern int
    ivox_nearby_type;  ///< 近邻搜索类型 (0=中心 6=6邻域 18=18邻域 26=26邻域)
...
extern bool
    use_imu_as_input;  ///< true=IMU作为输入[24维], false=IMU作为输出[30维]
extern bool space_down_sample;  ///< 是否对降采样后点云再做空间降采样

// ==================== 外参标定 ====================
extern bool extrinsic_est_en;  ///< 是否在线估计 LiDAR-IMU 外参
extern bool
    publish_odometry_without_downsample;  ///< 是否逐点发布里程计 (vs 逐帧发布)
...
// ==================== IMU 参数 ====================
extern bool imu_enabled;         ///< 是否启用 IMU
