...
def generate_launch_description():
    ...
    # base_footprint to chassis static transform
    ...
    # chassis to gimbal_yaw_odom static transform
    ...
    # gimbal_yaw_odom to gimbal_pitch_odom static transform
