...
namespace bridge {
  ...
  BridgeNode::BridgeNode(const rclcpp::NodeOptions& options)
    ...
    com_ = std::make_shared<SerialCommunicationClass>(this, port_name_,
                                                      baud_rate_);
    ...
    bridge_twist_pc_ =
        std::make_shared<RosSerialBridge<geometry_msgs::msg::Twist>>(
            ...
            nullptr,
            std::bind(&SerialCommunicationClass::sendDataFrame, com_.get(),
                      std::placeholders::_1, std::placeholders::_2),
            nullptr, nullptr);

    bridge_Yaw_mcu_ = std::make_shared<RosSerialBridge<std_msgs::msg::Float32>>(
        this, "/serial/Yaw", false, nullptr,
        std::bind(&BridgeNode::decodeYaw, this, std::placeholders::_1), nullptr,
    ...
    game_status_pub_ =
        this->create_publisher<pb_rm_interfaces::msg::GameStatus>(
            "/referee/game_status", 10);

    rfid_status_pub_ =
        this->create_publisher<pb_rm_interfaces::msg::RfidStatus>(
