...
// ══════════════════════════════════════════════════════════════════════════════
  bool JPSAlgorithm::generatePath(const JPSConfig& c, JPSState& s, int sx, int sy,
                                int gx, int gy,
  ...
  while (!s.open_list_.empty()) {
    ...
    for (auto [succ, jump_cost] : successors) {
      ...
      double tentative_g = current->g + jump_cost
                           + planner.euclideanCost(c, current->x, current->y, succ->x,
                                           succ->y);
...
std::vector<std::pair<double, double>>JPSAlgorithm::detourCornerHuggingDiagonals(
    const std::vector<std::pair<double, double>>& path,
    const unsigned char* costmap_data, int cm_w, int cm_h, bool allow_unknown) {
