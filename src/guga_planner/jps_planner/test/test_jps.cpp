...
namespace jps_planner {
  ...
  protected:
    ...
    void expectPath(JPSState& state, int sx, int sy, int gx, int gy) {
      std::vector<std::pair<double, double>> path{};
      bool ok = JPSAlgorithm::generatePath(config_, state, sx, sy, gx, gy,
                                           path);
      EXPECT_TRUE(ok);
  ...
  TEST_F(JPSSearchTest, EmptyGrid_StraightHorizontal) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 10, 50, 90, 50, path);
    EXPECT_TRUE(ok);
    EXPECT_GE(path.size(), 2u);
  ...
  TEST_F(JPSSearchTest, EmptyGrid_StraightVertical) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 50, 10, 50, 90, path);
    EXPECT_TRUE(ok);
    EXPECT_GE(path.size(), 2u);
  }
  ...
  TEST_F(JPSSearchTest, EmptyGrid_Diagonal) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 10, 10, 90, 90, path);
    EXPECT_TRUE(ok);
    EXPECT_GE(path.size(), 2u);
  }
  ...
  TEST_F(JPSSearchTest, GridWithWall_FindsPathAround) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 5, 5, 15, 5, path);
    EXPECT_TRUE(ok);
    EXPECT_GE(path.size(), 2u);
  ...
  TEST_F(JPSSearchTest, BlockedStart_ReturnsFalse) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 0, 3, 3, 0, path);
    EXPECT_FALSE(ok);
  ...
  TEST_F(JPSSearchTest, BlockedGoal_ReturnsFalse) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 0, 3, 3, 3, path);
    EXPECT_FALSE(ok);
  }
  ...
  TEST_F(JPSSearchTest, NoPath_EnclosedGoal) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 0, 4, 1, 1, path);
    EXPECT_FALSE(ok);
  }
  ...
  TEST_F(JPSSearchTest, NarrowCorridor_FindsPath) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 1, 5, 19, 5, path);
    EXPECT_TRUE(ok);
  ...
  TEST_F(JPSBehaviorTest, Jump_HitsObstacle_StopsBefore) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 1, 2, 11, 2, path);
    EXPECT_TRUE(ok);
  ...
  TEST_F(JPSBehaviorTest, Jump_HitsGoal_ReturnsGoalNode) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 25, 25, 40, 25, path);
    EXPECT_TRUE(ok);
  ...
  TEST_F(JPSBehaviorTest, DiagonalJump_CreatesJumpPoints) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 10, 10, 80, 80, path);
    EXPECT_TRUE(ok);
    EXPECT_GE(path.size(), 2u);
  ...
  TEST_F(JPSBehaviorTest, JPS_ExpandsFewerNodes) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 5, 5, 195, 195, path);
    EXPECT_TRUE(ok);
    ...
    EXPECT_LT(nodes_created, 100u) << "JPS created " << nodes_created
                                   << " nodes on empty grid (expected <100)";
  ...
  TEST_F(JPSEdgeCaseTest, StartEqualsGoal_ReturnsSinglePoint) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 10, 10, 10, 10, path);
    EXPECT_TRUE(ok);
  ...
  TEST_F(JPSEdgeCaseTest, BoundaryPath_StaysInBounds) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 0, 49, 49, 49, path);
    EXPECT_TRUE(ok);
  ...
  TEST_F(JPSEdgeCaseTest, OriginStart_Works) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 0, 0, 29, 29, path);
    EXPECT_TRUE(ok);
  }
  ...
  TEST_F(JPSEdgeCaseTest, AdjacentCells_Works) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 5, 5, 6, 5, path);
    EXPECT_TRUE(ok);
  ...
  TEST_F(JPSEdgeCaseTest, OutOfBounds_Start_ReturnsFalse) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, -1, 5, 10, 10, path);
    EXPECT_FALSE(ok);
  }
  ...
  TEST_F(JPSEdgeCaseTest, OutOfBounds_Goal_ReturnsFalse) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 5, 5, 20, 10, path);
    EXPECT_FALSE(ok);
  }
  ...
  TEST_F(JPSCostTest, HighCostRegion_PathPrefersFree) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 10, 5, 10, 15, path);
    EXPECT_TRUE(ok);
  ...
  TEST_F(JPSCostTest, AllowUnknown_PathThroughUnknown) {
    ...
    std::vector<std::pair<double, double>> path{};
    bool ok = JPSAlgorithm::generatePath(config_, state, 5, 4, 5, 0, path);
    EXPECT_TRUE(ok);
  }
