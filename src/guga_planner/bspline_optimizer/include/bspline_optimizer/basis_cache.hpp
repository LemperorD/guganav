...
namespace bspline_optimizer::detail {
  ...
  public:
    ...
    CostCache buildCostCache(const Eigen::RowVectorXd& knots, int M,
    ...
    void fillCtrl(const std::vector<double>& params, double first_x,
  ...
  private:
    ...
    void basisDerivsAt(double u, const Eigen::RowVectorXd& knots, int p, int M,
                       std::vector<double>& N, std::vector<double>& N1,
