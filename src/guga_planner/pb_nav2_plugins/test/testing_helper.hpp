...
void addObstacleLayer(
  ...
  std::shared_ptr<pb_nav2_costmap_2d::ObstacleLayerLocal> & olayer,
  rclcpp::CallbackGroup::SharedPtr callback_group = nullptr)
{
  olayer = std::make_shared<pb_nav2_costmap_2d::ObstacleLayerLocal>();
...
void addObservation(
  std::shared_ptr<pb_nav2_costmap_2d::ObstacleLayerLocal> olayer, double x, double y,
  double z = 0.0, double ox = 0.0, double oy = 0.0, double oz = MAX_Z, bool marking = true,
  bool clearing = true, double raytrace_max_range = 100.0, double raytrace_min_range = 0.0,
