...
namespace sensor_scan_generation_old
{
  ...
  const sensor_msgs::msg::PointCloud2::ConstSharedPtr & pcd_msg)
{
  ...
  std::cout << RED_LIGHT <<"laserCloudAndOdometryHandler duration: " << duration.count() << " ms" << RESET << std::endl;
#endif
}
...
RCLCPP_COMPONENTS_REGISTER_NODE(sensor_scan_generation_old::SensorScanGenerationNode)
